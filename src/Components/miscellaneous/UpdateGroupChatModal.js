...
const UpdateGroupChatModal = ({ fetchAgain, setFetchAgain, fetchMessage }) => {
    ...
    const handleAddUser = async (user1) => {
        ...
        try {
            ...
            const { data } = await axios.put(
                `https://we-are-buddy.herokuapp.com/api/chat/groupadd`,
                {
    ...
    const handleRemove = async (user1) => {
        ...
        try {
            ...
            const { data } = await axios.put(
                `https://we-are-buddy.herokuapp.com/api/chat/groupremove`,
                {
                    chatId: selectedChat._id,
                    userId: user1._id,
                },
    ...
    const handleRename = async () => {
        ...
        try {
            ...
            const { data } = await axios.put(
                `https://we-are-buddy.herokuapp.com/api/chat/rename`,
                {
                    chatId: selectedChat._id,
        ...
        <>
            ...
            <Modal onClose={onClose} isOpen={isOpen} isCentered>
                ...
                <ModalContent>
                    ...
                    <ModalCloseButton onClick={removeResultAfterleave} />
                    <ModalBody>
                        <Box>
